 ...
 * 
 * A grammar matrix can combine text and other grammar matrices, this allows for a tree structure
 * of grammars and can be very powerful in creating dynamic and flexible phrase constructs.
 * 
 * These matrices are directly related to the JSGF spec. They are essentially wrappers to JSGF Rules.
 * 
 * @author Hammer
 *
 */
public class GrammarMatrix {
	...
	/**
	 * Get the entire phrase sequence as an ArrayList of String Array and Grammar Matrix objects 
